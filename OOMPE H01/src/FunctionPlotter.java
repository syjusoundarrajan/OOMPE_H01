...
public class FunctionPlotter {
	...
	public FunctionPlotter(double lowerBoundX, double upperBoundX, UserFunction function)
	{
	...
	public void plot(Viewer viewerObj) {
		...
		//Following gives us the boundaries and the axes ie) X and Y axis
	...
	//Defines the number of steps for the plot
